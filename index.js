...
function kataakhir(){
      ...
      strings: ["" + tekspalingakhir], startDelay: 50, speed: 60, cursor: true,
      afterComplete: function(){
...
function menuju(){if(fungtom2==1){window.location = "https://api.whatsapp.com/send?phone=082351437523&text=" + pesanwhatsapp;}}
